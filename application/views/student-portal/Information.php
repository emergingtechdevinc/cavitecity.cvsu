        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo base_url();?>profile" class="nav-link  active">
                        ...
                        <div class="card  card-outline">
                            <div class="card-body box-profile">
                                <div class="text-center" style="margin-top:40px; margin-bottom:20px">
                                    <img class="profile-user-img img-fluid img-circle" src="<?php echo base_url();?>assets/images/users/<?php echo $this->session->student_image;?>" alt="User profile picture">
                                </div>
                                <?php foreach ($sfData as $sfRow){?>
                                    <h3 class="profile-username text-center"><?php echo $sfRow->studentNumber; ?></h3>
                                    <p style="margin-bottom:40px" class="text-muted text-center"><?php echo strtoupper($sfRow->firstName); ?> <?php if($sfRow->middleName!='N/A'){ echo strtoupper($sfRow->middleName);}?> <?php echo strtoupper($sfRow->lastName); ?></p>
                                <?php } ?>
                                ...
                                <ul class="list-group list-group-unbordered mb-3">
                                    ...
                                    <li class="list-group-item">
                                        <b>COURSE</b> <a class="float-right"><?php echo $courseName; ?></a>
                                    </li>
                                    <li class="list-group-item">
                                        <b>MAJOR</b> <a class="float-right"><?php if($courseName=='BSBM') {echo 'MARKETING MANAGEMENT';} else {echo $Major;}  ?></a>
                                    </li>
                                    <li class="list-group-item">
                                        <b>YEAR LEVEL</b> <a class="float-right"><?php if($YL==1){ echo 'FIRST YEAR'; } elseif ($YL==2) { echo 'SECOND YEAR'; } elseif ($YL==3) { echo 'THIRD YEAR'; } elseif ($YL==4) { echo 'FOURTH YEAR'; } else { echo 'IRREGULAR'; } ?></a>
                                    </li>

                                </ul>
                                <a href="#" class="btn btn-primary btn-block"><b>Update Profile Information</b></a>
                            </div>
